 ...
 */
async function findFiles(dir: any, pattern: any): any {
 ...
 */
async function displayMenu(testFiles: any): any {
 ...
 */
async function migrateFile(filePath: any): any {
  return new Promise((resolve) => {
    console.log(`\nMigrating ${filePath}...`);

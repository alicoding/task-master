  ...
  async executeCommand(
    ...
    if (context.isDryRunMode()) {
      ...
      return {
        ...
        status: (params.status ?? currentTask.status) as TaskStatus,
        readiness: (params.readiness ?? currentTask.readiness) as TaskReadiness,
        tags: params.tags ?? currentTask.tags,
        parentId: params.parentId ?? currentTask.parentId,
        metadata: (metadata ?? currentTask.metadata) as Partial<TaskMetadata>,

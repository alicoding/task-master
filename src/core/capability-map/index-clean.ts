...
import { calculateSimilarity } from '@/core/nlp/processor';
import { v4 as uuidv4 } from 'uuid';
import { discoverCapabilitiesEnhanced } from '@/core/capability-map/enhanced-discovery';
import { discoverEnhancedRelationships } from '@/core/capability-map/enhanced-relationships';
    ...
    try {
      ...
      if (options.includeCompletedTasks === false) {
        ...
        try {
          ...
          const result = await this.repository.searchTasks({
          ...
          const allTasksResult = await this.repository.getAllTasks();

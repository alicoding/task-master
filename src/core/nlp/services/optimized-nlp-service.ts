...
import { addTaskEntities } from '@/core/nlp/processing/entities';
import {
  tryLoadModel,
  addTrainingExamples,
  trainAndSaveModel,
  DEFAULT_MODEL_PATH
} from '@/core/nlp/processing/trainer';
import {
  Tokenizer,
  Stemmer
...
import {
  ...
  getNlpCache
} from '@/core/nlp/processing/optimized-processor';
import {
  fuzzySearch,
  combineSearchResults
} from '@/core/nlp/matchers/fuzzy-matcher';
import { getNlpProfiler, profileMethod } from '@/core/nlp/utils/profiler';

// Import the ESM-compatible NlpManager
import { NlpManager } from '@/core/nlp/esm-compat/nlp-manager';

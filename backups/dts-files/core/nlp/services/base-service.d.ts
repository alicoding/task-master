 ...
 */
import { NlpServiceInterface, ProcessedQuery, TaskSearchInfo, SimilarTask, ExtractedSearchFilters } from '../types';
/**
 * Abstract base class for NLP services
 * Defines the common interface for different NLP service implementations
 */
export declare abstract class BaseNlpService implements NlpServiceInterface {
    /**
     ...
     */
    abstract findSimilarTasks(tasks: TaskSearchInfo[], title: string, threshold?: number, useFuzzy?: boolean): Promise<SimilarTask[]>;
    /**

import { Task, TaskSearch, TaskCreateInput, TaskUpdateInput } from '../types';
/**
 ...
 */
export type Operation = AddOperation | UpdateOperation | DeleteOperation | GetOperation | SearchOperation | ExportOperation | ImportOperation;
/**
